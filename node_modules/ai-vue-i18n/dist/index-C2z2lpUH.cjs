...
class NodeHfsImpl {
				...
				if (error.code === "ENOENT") {
					const dirPath = require$$0.dirname(
						filePath instanceof URL
							? require$$3.fileURLToPath(filePath)
							: filePath,
					);
	...
	async copyAll(source, destination) {
		...
		const sourceStr =
			source instanceof URL ? require$$3.fileURLToPath(source) : source;

		const destinationStr =
			destination instanceof URL
				? require$$3.fileURLToPath(destination)
				: destination;
...
exports.Hfs = Hfs;
exports.NodeHfs = NodeHfs;
exports.NodeHfsImpl = NodeHfsImpl;
exports.hfs = hfs;
