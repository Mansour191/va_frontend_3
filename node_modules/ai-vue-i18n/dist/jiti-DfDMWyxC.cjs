...
var require$$6 = require('node:assert');
var require$$5 = require('node:process');
var require$$0$2 = require('node:path');
var require$$7 = require('node:v8');
var require$$8 = require('node:util');
var require$$9 = require('node:crypto');
var require$$10 = require('node:tty');
var require$$11 = require('node:perf_hooks');
var require$$12 = require('node:vm');
require('path');
require('assert');
require('module');
require('events');
...
function lazyTransform(...args) {
  if (!_transform) {
    _transform = require$$0.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('jiti-DfDMWyxC.cjs', document.baseURI).href)))("../dist/babel.cjs");
  }
...
function createJiti(id, opts = {}) {
  ...
  return _createJiti(id, opts, {
    onError,
    nativeImport,
    createRequire: require$$0.createRequire,
  });
}
